...
const switchBtnWidth = 40;
const switchBtnHeight = 70;
const tourchFixTop = switchBtnRect.top + switchBtnHeight / 2 + "px";
const tourchFixLeft = switchBtnRect.left + switchBtnWidth / 2 + "px"
...
// Set Fix Tourch
const setFixTourch = () => {
    document.documentElement.style.setProperty("--tourch-fix-top", tourchFixTop);
    document.documentElement.style.setProperty("--tourch-fix-left", tourchFixLeft);
}
...
window.addEventListener('resize', debounce((e) => {
    setFixTourch();
    console.log("here: line #170"); // TODO: ⬅️ DELETE 
}),30);
